...
export const CustomerRegister: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 sm:p-6 lg:p-10 font-sans">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-slate-800 min-h-[540px]">
        ...
        <div className="w-full md:w-64 lg:w-72 bg-[#091526] text-white p-8 sm:p-10 flex flex-col justify-between items-center text-center z-10 shrink-0">
          <div className="my-auto flex flex-col items-center">
            <div className="mb-4 p-4 rounded-2xl bg-blue-500/10 border border-blue-500/20 text-blue-400">
            ...
            <div className="w-10 h-1 bg-blue-500 my-4 rounded-full" />
        ...
        <div className="flex-1 bg-white text-slate-900 p-8 sm:p-10 lg:p-12 flex flex-col justify-between max-w-xl mx-auto w-full z-10">
          <div>
              ...
              <div className="space-y-4 mt-2">
                ...
                <form onSubmit={handleRegisterSubmit} className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:ring-2 focus:ring-slate-900 outline-none"
                      />
                    </div>
                    <div>
                      <label className="block text-slate-700 text-xs font-bold mb-1">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3.5 px-4 rounded-xl shadow-lg font-bold text-white bg-[#0a182e] hover:bg-[#071120] transition-all text-xs uppercase tracking-wider flex items-center justify-center gap-2 mt-2"
                  >
            ...
            {step === 2 && registeredData && (
              <div className="text-center py-6 space-y-5">
                ...
                <div className="space-y-1">
                  <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-[10px] font-extrabold uppercase border border-emerald-200">
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 max-w-sm mx-auto">
                  ...
                  <p className="font-mono text-xl font-black text-blue-600 mt-0.5">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl shadow-lg font-bold text-white bg-[#0a182e] hover:bg-[#071120] transition-all text-xs uppercase tracking-wider flex items-center justify-center gap-2"
                >
