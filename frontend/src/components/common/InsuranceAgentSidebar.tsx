...
export const InsuranceAgentSidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-[#f3edfd] text-slate-800 flex flex-col justify-between transition-transform duration-300 ease-in-out lg:static lg:translate-x-0 border-r border-purple-200/70 shadow-sm ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
      >
        <div className="flex flex-col h-full overflow-hidden">
          {/* Header Logo & Insurance Desk Role Badge */}
          <div className="p-5 flex flex-col items-center justify-center relative bg-[#f3edfd]">
            ...
            <div className="mt-3.5 px-4 py-1.5 rounded-full bg-white/90 text-purple-900 border border-purple-300/80 text-xs font-extrabold shadow-sm flex items-center gap-1.5">
